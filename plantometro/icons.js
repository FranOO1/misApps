// Diccionario de iconos SVG Pro para la app de Fran
const Icons = {
    leaf: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 3.5 1 8.5C18.5 14 14 19 11 20z"></path><path d="M19 2c-2.26 4.33-5.27 7.14-8 10"></path></svg>`,
    ...
    upload: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" x2="12" y1="3" y2="15"></line></svg>`,
...
function loadAppIcons() {
    document.querySelectorAll('[data-icon]').forEach(el => {
        ...
        if (Icons[iconName]) {
            ...
            if (svg && el.getAttribute('data-class')) {
                svg.setAttribute('class', el.getAttribute('data-class'));
            }
        }
    });
}

// Ejecución inmediata al leer el archivo para asegurar que pinte la cabecera antes del DOM
document.addEventListener("DOMContentLoaded", loadAppIcons);
